...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
       <h5><b><span class="fa fa-money "></span> Payment Complete</b></h5>
  </header>
...
$result1 = mysql_query("UPDATE card SET balance='$update' WHERE cardnumber = '$card'");
if (!$result1) {
    echo 'Could not run query: ' . mysql_error();
    exit;
}
...
$result2 = mysql_query("INSERT INTO log (time, ammount, card, user)
VALUES ('$created_date', '$package', '$card', '$user')");
if (!$result2) {
    echo 'Could not run query: ' . mysql_error();
    exit;
}
