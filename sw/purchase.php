...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-row-padding w3-margin-bottom">
        <button name="choose" value="99" type="submit" class="button button2">
...
<button name="choose" value="200" type="submit" class="button button2">
...
<a href="../en/purchase.php"><button class="button1 button3">English</button></a>
