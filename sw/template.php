...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Dashibodi yangu</b></h5>
  </header>
...
// Debug level handler
$debugHandler = new StreamHandler('log/purchase.log', Logger::INFO);
$debugHandler->setFormatter($formatter);
// Error level handler
$errorHandler = new StreamHandler('log/purchase.log', Logger::ERROR);
